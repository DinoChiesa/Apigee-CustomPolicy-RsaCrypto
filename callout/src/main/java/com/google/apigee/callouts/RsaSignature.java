...
public class RsaSignature extends RsaBase implements Execution {
  ...
  private static Signature getSignatureInstance(PSSHashes pssHashes)
  ...
  public static byte[] sign(PrivateKey privateKey, byte[] data, PSSHashes pssHashes)
      throws Exception {
    Signature signer = getSignatureInstance(pssHashes);
  ...
  public static boolean verify(
      PublicKey publicKey, byte[] data, byte[] signature, PSSHashes pssHashes) throws Exception {
    Signature verifier = getSignatureInstance(pssHashes);
  ...
  public ExecutionResult execute(MessageContext msgCtxt, ExecutionContext exeCtxt) {
    ...
    try {
      ...
      if (action == SignAction.SIGN) {
        ...
        byte[] signature = sign(privateKey, source, pssHashes);
        ...
        boolean verified = verify(publicKey, source, signature, pssHashes);
